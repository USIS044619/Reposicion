...
public class agregarVehiculo extends AppCompatActivity {
        ...
        imgFotoProducto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if (photoFile != null) {
                        try {
                            Uri photoURI = FileProvider.getUriForFile(agregarVehiculo.this, "com.example.ControlesBasicos.fileprovider", photoFile);
        ...
        btnVehiculos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!marca.isEmpty() && !modelo.isEmpty() && !year.isEmpty() && !numeromodelo.isEmpty() && !numerochasis.isEmpty()){
                    ...
                    miDB = new db_Class_vehiculos(getApplicationContext(), "", null, 1);
    ...
    void mostrarListaVehiculos(){
        Intent mostrarVehiculos = new Intent( agregarVehiculo.this, MainActivity.class);
