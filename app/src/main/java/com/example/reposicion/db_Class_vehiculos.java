...
public class db_Class_vehiculos extends SQLiteOpenHelper {
    ...
    public db_Class_vehiculos(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
